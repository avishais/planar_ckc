% In this experiment I test the GD and PCS with the BiRRT planner while varying the step size
% are:
...
%%
D1 = load('benchmark_BiRRT_PCS_obs_rangeB.txt'); 

D2 = load('benchmark_BiRRT_GD_obs_rangeB.txt'); 

D3 = load('benchmark_BiRRT_HB_obs_rangeB.txt'); 
